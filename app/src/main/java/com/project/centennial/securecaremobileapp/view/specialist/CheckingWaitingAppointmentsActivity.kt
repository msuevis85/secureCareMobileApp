...
class CheckingWaitingAppointmentsActivity : DrawerBaseActivity(), CheckingWaitingAppointmentAdapter.WaitingAppointmentId {
    ...
    override fun onConfirmAppointment(appointmentid: String) {
        Log.d("onConfirmAppointment: ",appointmentid)
        checkingWaitingViewModel.confirmApppointment(token, appointmentid)
    }
